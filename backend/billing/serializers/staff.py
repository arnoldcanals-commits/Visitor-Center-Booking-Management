...
# BILL TEMPLATE
# =====================================================
class StaffBillTemplateSerializer(serializers.ModelSerializer):
    class Meta:
        model = BillTemplate
        fields = [
            "id",
...
# FEE TYPE
# =====================================================
class StaffFeeTypeSerializer(serializers.ModelSerializer):
    class Meta:
        model = FeeType
        fields = [
            "id",
...
# BILL ITEM
# =====================================================
class StaffBillItemSerializer(serializers.ModelSerializer):
...
# BILL
# =====================================================
class StaffBillSerializer(serializers.ModelSerializer):
    ...
    items = StaffBillItemSerializer(many=True, read_only=True)
