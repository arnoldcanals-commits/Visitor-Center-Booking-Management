...
function ModalSearch({
  ...
  <div className="relative">
    ...
    <input
      ...
      ref={searchInput}
      className="w-full dark:text-gray-300 bg-white dark:bg-gray-800 border-0 focus:ring-transparent placeholder-gray-400 dark:placeholder-gray-500 appearance-none py-3 pl-4 pr-10"
    />
